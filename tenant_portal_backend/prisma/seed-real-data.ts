    ...
    try {
      await prisma.lease.upsert({
        ...
        update: {
          ...
          rentAmountCents: Math.round(leaseData.rentAmount * 100),
          depositAmount: leaseData.depositAmount,
          depositAmountCents: Math.round(leaseData.depositAmount * 100),
          currentBalance: leaseData.currentBalance ?? 0,
          currentBalanceCents: Math.round((leaseData.currentBalance ?? 0) * 100),
