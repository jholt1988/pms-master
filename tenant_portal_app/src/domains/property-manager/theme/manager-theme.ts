/**
 * Property Manager Domain Theme
 * Extends base design tokens with NextUI configuration for property manager experience
 */

import { baseColors, radius, shadows } from '../../../design-tokens';

export const propertyManagerTheme = {
  extend: {
    colors: {
      ...
      primary: {
        ...
        DEFAULT: baseColors.primary[700], // Slightly darker for manager role
        foreground: '#ffffff',
      },
      success: {
...
export type PropertyManagerTheme = typeof propertyManagerTheme;
