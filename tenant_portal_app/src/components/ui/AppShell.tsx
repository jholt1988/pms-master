...
export const AppShell: React.FC<AppShellProps> = ({ onLogout, children }) => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-deep-900 font-sans text-slate-100">
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-deep-900 via-deep-800 to-black animate-gradient-move opacity-80" />
      <div className="pointer-events-none absolute inset-0 bg-grid-pattern bg-[length:90px_90px] opacity-20" />
